...
export async function productionRoutes(app: FastifyInstance) {
  ...
  // GET /api/v1/production/workshop
  ...
  // POST /api/v1/production/:id/claim
  ...
  // PATCH /api/v1/production/:id/assign
  ...
  // POST /api/v1/production/:id/flag
  ...
  // POST /api/v1/production/:id/unflag
  ...
  // PATCH /api/v1/production/:id/defect
