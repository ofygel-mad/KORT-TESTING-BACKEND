...
export async function invoicesRoutes(app: FastifyInstance) {
  ...
  // POST /api/v1/invoices — Create invoice from order IDs
  ...
  // PATCH /api/v1/invoices/:id/document — Save preview/editor changes
  ...
  // POST /api/v1/invoices/:id/confirm-seamstress
  ...
  // POST /api/v1/invoices/:id/confirm-warehouse
  ...
  // POST /api/v1/invoices/:id/archive — Archive after download
  ...
  // GET /api/v1/invoices/:id/download — Download XLSX
