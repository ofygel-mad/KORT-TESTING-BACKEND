// ── Order types — synced with backend Prisma schema ──────────────────────────
// Backend models: Order, OrderItem, ProductionTask, Payment, OrderActivity
...
export interface Order {
  ...
  isDemandingClient: boolean;  // new: independent demanding-customer flag
