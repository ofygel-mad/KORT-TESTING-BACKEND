...
export function calculateOrderFinancials(input: OrderFinancialInput): OrderFinancialSummary {
...
export function getOrderBalance(totalDue: number, paidAmount: number) {
