...
//
// This file MUST be kept byte-identical with server/src/shared/__tests__/variant-key.fixture.ts
// on the backend. Both contract tests load the same cases and assert identical output;
