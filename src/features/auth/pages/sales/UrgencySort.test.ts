 ...
 * Tests the sort comparator used in OrdersPage and ProductionFloorPage.
 */
import { describe, expect, it } from 'vitest';
import type { Order } from '@/entities/order/types';

// Mirrors the sort logic in OrdersPage.tsx
function sortByUrgency(orders: Pick<Order, 'urgency' | 'priority'>[]): typeof orders {
