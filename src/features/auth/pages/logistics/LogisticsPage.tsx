...
export default function ShippingPage() {
  ...
  const orders: Order[] = (tab === 'pending' ? pendingQuery.data?.results : tab === 'shipped' ? shippedQuery.data?.results : []) ?? [];
...
function ShippingRow({ order, onClick }: { order: Order; onClick: () => void }) {
