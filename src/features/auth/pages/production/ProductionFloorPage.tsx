...
import type { ChangeRequest, ProductionStatus, ProductionTask } from '@/entities/order/types';
...
import styles from './ProductionFloorPage.module.css';

type WorkshopViewMode = 'table' | 'card';

function viewStorageKey(userId?: string) {
  return `kort_production_view_${userId ?? 'guest'}`;
}
...
export default function ProductionPage() {
  ...
  const { canManageProduction } = useOperationsAccess();
