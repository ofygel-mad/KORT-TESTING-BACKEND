...
import { useAnalytics } from '@/entities/analytics/queries';
...
export default function AnalyticsPage() {
  ...
  const { data, isLoading, isError } = useAnalytics(periodToDates(period));
...
function OverviewTables({ data }: { data: NonNullable<ReturnType<typeof useAnalytics>['data']> }) {
...
function ChartsView({ data }: { data: NonNullable<ReturnType<typeof useAnalytics>['data']> }) {
